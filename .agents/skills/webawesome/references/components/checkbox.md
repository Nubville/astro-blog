...
<form class="custom-validity">
  ...
  <br />
  <wa-button appearance="filled" type="submit" variant="neutral" style="margin-top: 1rem;"
    >Submit</wa-button
  >
</form>
<script>
...
```js
import 'https://ka-f.webawesome.com/webawesome@3.6.0/components/checkbox/checkbox.js';
```
