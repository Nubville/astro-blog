...
<p>
  Native styles set consistent spacing between block-level elements using your theme's design
  tokens. This means headings, paragraphs, lists, and other elements look great together without
  extra effort.
</p>
<blockquote>
...
<p>
  Spacing is controlled by the <code>--wa-content-spacing</code> token, so you can easily adjust it
  to match your design. Set it to zero if you prefer to handle spacing yourself.
</p>
<hr />
<ul>
...
```html
<p>
  Paragraphs inherit the default text styles set on the body element, including font family, size,
  weight, and line height. They also use <code>text-wrap: pretty</code> to prevent orphaned lines in
  supported browsers.
</p>

<p>
  You can have as many paragraphs as you need and they'll maintain consistent spacing between them.
  Native styles ensure everything stays readable and well-proportioned, no matter how much content
  you throw at it.
</p>
```
...
```html
<blockquote>
  What is a Web year now, about three months? And when people can browse around, discover new
  things, and download them fast, when we all have agents - then Web years could slip by before
  human beings can notice.<br /><br />
  — Tim Berners-Lee
</blockquote>
```
...
<dl>
  ...
  <dd>
    A set of web platform APIs that let you create custom, reusable HTML elements. They work across
    frameworks and browsers, making them ideal for building design systems and component libraries.
  </dd>
  <dt>Shadow DOM</dt>
  <dd>
    A browser feature that lets you attach a hidden DOM tree to an element. This keeps your
    component's styles and markup encapsulated, so they won't accidentally interfere with the rest
    of the page.
  </dd>
  <dt>Custom Elements</dt>
  <dd>
    A JavaScript API that lets you define new HTML tags with their own behavior. Once registered,
    you can use them anywhere in your markup just like built-in elements.
  </dd>
</dl>
```
...
<details>
  ...
  <p>
    Click the summary to expand and reveal this content. Native details elements are styled to
    closely match the appearance of the <code>&lt;wa-details&gt;</code> component, so they fit right
...
<div class="wa-stack">
  ...
  <div class="wa-cluster">
    ...
    <label class="wa-size-xs"
      ><input type="radio" name="radio-xs" value="1" checked /> Extra small radio</label
    >
  </div>
  ...
  <div class="wa-cluster">
    ...
    <label class="wa-size-s"
      ><input type="radio" name="radio-small" value="1" checked /> Small radio</label
    >
  </div>
  ...
  <div class="wa-cluster">
    ...
    <label class="wa-size-m"
      ><input type="radio" name="radio-medium" value="1" checked /> Medium radio</label
    >
  </div>
  ...
  <div class="wa-cluster">
    ...
    <label class="wa-size-l"
      ><input type="radio" name="radio-large" value="1" checked /> Large radio</label
    >
  </div>
  ...
  <div class="wa-cluster">
    ...
    <label class="wa-size-xl"
      ><input type="radio" name="radio-xl" value="1" checked /> Extra large radio</label
    >
  </div>
</div>
```
